...
dotnet ef dbcontext scaffold "Server=localhost;Database=Microsoft.eShopOnWeb.CatalogDb;Trusted_Connection=False;User ID=sa; Password=P@55w0rd;" Microsoft.EntityFrameworkCore.SqlServer --output-dir Models --force
```
...
```sql
INSERT INTO [Microsoft.eShopOnWeb.CatalogDb].[dbo].[CatalogBrand] ([Id]
      ,[Brand])
VALUES (1, 'Brand 1');

INSERT INTO [Microsoft.eShopOnWeb.CatalogDb].[dbo].[CatalogType] ([Id]
      ,[Type])
VALUES (1, 'Type 1');
```
